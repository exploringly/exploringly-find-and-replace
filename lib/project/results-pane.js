...
class ResultsPaneView {
  constructor() {
    ...
    this.subscriptions = new CompositeDisposable(
      ...
      atom.config.observe('exploringly-find-and-replace.searchContextLineCountBefore', this.searchContextLineCountChanged.bind(this)),
      atom.config.observe('exploringly-find-and-replace.searchContextLineCountAfter', this.searchContextLineCountChanged.bind(this))
    );
  }
              ...
              $.div({className: 'btn-group'},
                ...
                $.button(
                  ...
                  $.svg(
                    {
                      className: 'icon',
                      innerHTML: '<use xlink:href="#exploringly-find-and-replace-context-lines-before" />'
                    }
                  )
                ),
                $.button(
              ...
              $.div({className: 'btn-group'},
                ...
                $.button(
                  ...
                  $.svg(
                    {
                      className: 'icon',
                      innerHTML: '<use xlink:href="#exploringly-find-and-replace-context-lines-after" />'
                    }
                  )
                ),
                $.button(
  ...
  searchContextLineCountChanged() {
    this.searchContextLineCountBefore = atom.config.get('exploringly-find-and-replace.searchContextLineCountBefore');
    this.searchContextLineCountAfter = atom.config.get('exploringly-find-and-replace.searchContextLineCountAfter');
...
module.exports.URI = "atom://exploringly-find-and-replace/project-results";
