...
describe("SelectNext", () => {
  ...
  beforeEach(async () => {
    ...
    const activationPromise = atom.packages.activatePackage("exploringly-find-and-replace");
    atom.commands.dispatch(editorElement, 'exploringly-find-and-replace:show');
    await activationPromise;
  });

  describe("exploringly-find-and-replace:select-next", () => {
    describe("when nothing is selected", () => {
      it("selects the word under the cursor", () => {
        editor.setCursorBufferPosition([1, 3]);
        atom.commands.dispatch(editorElement, 'exploringly-find-and-replace:select-next');
  ...
  describe("exploringly-find-and-replace:select-all", () => {
    describe("when there is no selection", () => {
      it("find and selects all occurrences of the word under the cursor", () => {
        ...
        atom.commands.dispatch(editorElement, 'exploringly-find-and-replace:select-all');
        expect(editor.getSelectedBufferRanges()).toEqual([
          [[0, 0], [0, 3]],
          [[3, 8], [3, 11]],
          [[5, 6], [5, 9]]
  ...
  describe("exploringly-find-and-replace:select-undo", () => {
    describe("when there is no selection", () => {
      it("does nothing", () => {
        editor.setText(dedent`
          for
        ...
        atom.commands.dispatch(editorElement, 'exploringly-find-and-replace:select-undo');
        expect(editor.getSelectedBufferRanges()).toEqual([
          [[0, 0], [0, 0]]
        ]);
      })
  ...
  describe("exploringly-find-and-replace:select-skip", () => {
    describe("when there is no selection", () => {
      it("does nothing", () => {
        editor.setText(dedent`
          for
        ...
        atom.commands.dispatch(editorElement, 'exploringly-find-and-replace:select-skip');
        expect(editor.getSelectedBufferRanges()).toEqual([
          [[0, 0], [0, 0]]
        ]);
      })
